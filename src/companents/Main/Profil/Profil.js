            ...
            <div className="port__hero phero">
              <div className="phero__desc phdesc">
                ...
                <div className="phdesc__name">
                  <h3 className="phdesc__name">
                    {fnameVal} {lnameVal}
                  </h3>

                  <ul className="phdesc__bio">
                    <li className="phdesc__bio_item">
                      <p className="phdesc__bio_tit">
                        Tavallud: <span>May 01, 2007</span>
                      </p>
                    </li>
                    <li className="phdesc__bio_item">
                      <p className="phdesc__bio_tit">
                        Manzili: <span>Tashkent</span>
                      </p>
                    </li>
                    <li className="phdesc__bio_item">
                      <p className="phdesc__bio_tit">
                        Bio: <span>React dev interwip</span>
                      </p>
                    </li>
                  </ul>
                </div>
              ...
              <div className="port__hero_img_box">
                <img
                  className="port__hero_img"
                  src="https://imgur.com/1ZJeEbK.png"
                  alt="img"
                />
              </div>
            </div>
                  ...
                  <ul className="pmain-right__list">
                    {categorItems.map((itm, i) => (
                      <li className="pmain-right__item" key={i + 1}>
                        <button
                          className={`pmain-right__tit ${
                            itm.act ? "catbtns__btn-act" : ""
                          }`}
                          id={itm.id}
                          onClick={categorFunc}
                        >
                    ...
                    {saveObjId.map((idd) =>
                      saveObj.map((obj) =>
                        obj.bookObj.map((itm, i) =>
                          idd == itm.bookId ? (
                            <Link
                              to={`/BooksPages/${itm.bookId}`}
                              className="link"
                            >
                              <li className="pmain__books_item" key={i + 1}>
                                <img
                                  className="pmain__books_img"
                                  src={itm.bookImg}
                                  alt="user books"
                                />
                                <p className="pmain__books__name">
                                  {itm.bookName}
                                </p>
                                <p className="pmain__books__comment">
                                  <i className="bx bxs-star"></i>4.4 • 5200 ta
                                  fikrlar
                                </p>
                              </li>{" "}
                            </Link>
